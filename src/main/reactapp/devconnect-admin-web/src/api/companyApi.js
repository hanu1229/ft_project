...
export const signupCompany = async (companyDto) => {
    return axios.post('/api/company/signup', companyDto, {
...
export const loginCompany = async (companyDto) => {
    return axios.post('/api/company/login', companyDto, {
        headers: { 'Content-Type': 'application/json' },
    });
};
...
export const logoutCompany = (token) => {
    return axios.get('/api/company/logout', {
...
export const getCompanyList = () => {
    return axios.get('/api/company/findall');
};
...
export const updateCompanyState = (token, companyDto) => {
    return axios.put('/api/company/state', companyDto, {
        headers: {
...
/*
    ...
    응답 데이터: CompanyDto
*/
export const getCompanyDetail = (cno, token) => {
    return axios.get(`/api/company/detail?cno=${cno}`, {
        headers: { Authorization: `Bearer ${token}` },
    });
};
...
export const updateCompany = (token, companyDto) => {
    return axios.put('/api/company/update', companyDto, {
        headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/json',
        },
...
export const deleteCompany = (cno, token) => {
    return axios.delete(`/api/company?cno=${cno}`, {
        headers: { Authorization: `Bearer ${token}` },
    });
};