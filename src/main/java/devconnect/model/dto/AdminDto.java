...
import lombok.*; // [A] 롬복 어노테이션 import (Getter, Setter, Builder 등 자동 처리)

import java.time.LocalDateTime; // [B] 날짜 및 시간 관련 클래스 import

@Data // [C] Lombok 어노테이션 - Getter/Setter, toString 자동 생성
@NoArgsConstructor // [D] Lombok 어노테이션 - 기본 생성자 자동 생성
@AllArgsConstructor // [E] Lombok 어노테이션 - 전체 필드 초기화 생성자 자동 생성
@Builder // [F] Lombok 어노테이션 - 빌더 패턴 생성자 자동 생성
